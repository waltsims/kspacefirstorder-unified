...
//------------------------------------------------//
/// HDF5 error message.
ErrorMessage kErrFmtCannotCreateFile = "Error: Cannot create file %s.";
/// HDF5 error message.
...
/// HDF5 error message.
ErrorMessage kErrFmtCannotCloseFile = "Error: Cannot close file %s.";
/// HDF5 error message.
ErrorMessage kErrFmtCannotWriteDataset = "Error: Cannot write into dataset %s.";
/// HDF5 error message.
ErrorMessage kErrFmtCannotReadDataset = "Error: Cannot read from dataset %s.";
/// HDF5 error message.
...
/// HDF5 error message.
ErrorMessage kErrFmtCannotOpenGroup = "Error: Cannot open group %s in file %s.";
/// HDF5 error message.
...
ErrorMessage kErrFmtMatrixNotFloat =
    "Error: Matrix %s does not have correct data type, expected is single "
    "precision floating point.";
/// Matrix class error message.
ErrorMessage kErrFmtMatrixNotIndex =
    "Error: Matrix %s does not have correct data type, expected unsigned 64b "
    "long.";
/// Matrix class error message.
...
ErrorMessage kErrFmtBadMatrixType =
    "Error: Matrix %s cannot be created due to unknown type. [File, Line] : "
    "[%s,%d].";
...
/// Command line parameters error message.
ErrorMessage kErrFmtNoCompressionLevel = "Error: Invalid compression level.";
/// Command line parameters error message.
...
/// Command line parameters error message.
ErrorMessage kErrFmtNoVerboseLevel = "Error: Invalid verbose level.";

/// Command line parameters error message.
ErrorMessage kErrFmtNoInputFile = "Error: Input file was not specified.";
/// Command line parameters error message.
ErrorMessage kErrFmtNoOutputFile = "Error: Output file was not specified.";
/// Command line parameters error message.
...
ErrorMessage kErrFmtIllegalSamplingStartTimeStep =
    "Error: The beginning of data sampling is out of the simulation time span "
    "<%zu, %zu>.";

/// Command line parameters error message.
ErrorMessage kErrFmtBadInputFileFormat = "Error: Invalid input file %s format.";
/// Command line parameters error message.
...
ErrorMessage kErrFmtNonStaggeredVelocityNotSupportedFileVersion =
    "Error: --u_non_staggered_raw is not supported with input files of version "
    "1.0.";
/// Command line parameters error message.
ErrorMessage kErrFmtBadVelocitySourceMode =
    "Error: The velocity source mode type specified in the input file is not "
    "supported.";
/// Command line parameters error message.
ErrorMessage kErrFmtBadPressureSourceMode =
    "Error: The pressure source mode specified in the input file is not "
    "supported.";
/// Parameter error message.
ErrorMessage kErrFmtUnknownAbsorptionType = "Error: Unknown absorption type.";
/// Parameter error message.
...
ErrorMessage kErrFmtCheckpointDimensionsMismatch =
    "Error: Checkpoint file dimensions [%ld, %ld, %ld] don't match the "
    "simulation "
    "dimensions [%ld, %ld, %ld].";
/// KSpaceFirstOrderSolver error message.
...
ErrorMessage kErrFmtCannotCallR2CFftPlan1DZfor2D =
    "Error: Cannot call 1D real-to-complex FFT in z direction in 2D "
    "simulations.";
/// FFTW error message.
ErrorMessage kErrFmtCannotCallC2RFftPlan1DZfor2D =
    "Error: Cannot call 1D complex-to-real FFT in z direction in 2D "
    "simulations.";
...
/// FFTW error message.
ErrorMessage ErrFmtFftWisdomNotImported = "Warning: Cannot export FFTW wisdom.";
