...
OutputMessage kOutFmtDone = "  Done " + kOutFmtEol;
/// Output message - finish line without done.
OutputMessage kOutFmtNoDone = "       " + kOutFmtEol;
...
OutputMessage kOutFmtNumberOfThreads =
    kOutFmtVerticalLine +
    " Number of CPU threads:                              %9lu " + kOutFmtEol;
/// Output message.
...
OutputMessage kOutFmtElapsedTime =
    kOutFmtVerticalLine +
    " Elapsed time:                                    %11.2fs " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtRecoveredFrom =
    kOutFmtVerticalLine +
    " Recovered from time step:                            %8ld " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtMemoryUsage =
    kOutFmtVerticalLine +
    " Peak memory in use:                                %8luMB " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtTotalExecutionTime =
    kOutFmtVerticalLine +
    " Total execution time:                               %8.2fs " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtLegExecutionTime =
    kOutFmtVerticalLine +
    " This leg execution time:                            %8.2fs " + kOutFmtEol;
...
OutputMessage kOutFmtCurrentMemory =
    kOutFmtVerticalLine +
    " Current host memory in use:                        %8luMB " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtOutputFileUsage =
    kOutFmtVerticalLine +
    " Expected output file size:                        %9luMB " + kOutFmtEol;

/// Output message.
OutputMessage kOutFmtCheckpointCompletedTimeSteps =
    kOutFmtVerticalLine +
    " Number of time steps completed:                    %10u " + kOutFmtEol;
/// Output message.
...
OutputMessage kOutFmtCheckpointInterval =
    kOutFmtVerticalLine +
    " Checkpoint interval:                                %8lus " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtCheckpointTimeSteps =
    kOutFmtVerticalLine +
    " Checkpoint time steps:                               %8lu " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtCompressionLevel =
    kOutFmtVerticalLine +
    " Compression level:                                   %8lu " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtPrintProgressIntrerval =
    kOutFmtVerticalLine +
    " Print progress interval:                            %8lu%% " + kOutFmtEol;
/// Output message.
OutputMessage kOutFmtBenchmarkTimeStep =
    kOutFmtVerticalLine +
    " Benchmark time steps:                                %8lu " + kOutFmtEol;

/// Output message.
OutputMessage kOutFmtSamplingStartsAt =
    kOutFmtVerticalLine +
    " Sampling begins at time step:                        %8lu " + kOutFmtEol;
/// Output message.
...
OutputMessage kOutFmtWavePropagation =
    kOutFmtVerticalLine +
    " Wave propagation:                                   %9.9s " + kOutFmtEol;
/// Output message - medium type.
OutputMessage kOutFmtAbsorbtionType =
    kOutFmtVerticalLine +
    " Absorption type:                                    %9.9s " + kOutFmtEol;
/// Output message - medium type.
OutputMessage kOutFmtMediumParameters =
    kOutFmtVerticalLine + " Medium parameters:             %30.30s " +
    kOutFmtEol;

/// Output message - medium type.
OutputMessage kOutFmtAbsorbtionTypeLinear = "Linear";
/// Output message - medium type.
OutputMessage kOutFmtAbsorbtionTypeNonLinear = "Nonlinear";

/// Output message - medium type.
OutputMessage kOutFmtAbsorbtionLossless = "Lossless";
/// Output message - medium type.
OutputMessage kOutFmtAbsorbtionPowerLaw = "Power law";
/// Output message - medium type.
OutputMessage kOutFmtAbsorbtionStokes = "Stokes";

/// Output message - medium type.
OutputMessage kOutFmtMediumParametersHomegeneous = "Homogeneous";
/// Output message - medium type.
OutputMessage kOutFmtMediumParametersHeterogeneous = "Heterogeneous";
/// Output message - medium type.
...
OutputMessage kOutFmtSourceType =
    ...
    kOutFmtEol;
/// Output message - source type.
OutputMessage kOutFmtSourceMode = kOutFmtVerticalLine +
                                  " + Source condition:           %31.31s " +
                                  kOutFmtEol;

/// Output message - source type.
OutputMessage kOutFmtSourceMemoryUsage =
    kOutFmtVerticalLine +
    " + Memory usage:                                   %9.2fMB " + kOutFmtEol;

/// Output message - source type.
OutputMessage kOutFmtSourceTypeSingle = "Single";
/// Output message - source type.
OutputMessage kOutFmtSourceTypeMany = "Many";
/// Output message - source type.
OutputMessage kOutFmtSourceModeDirichlet = "Dirichlet";
/// Output message - source type.
OutputMessage kOutFmtSourceModeAdditive = "Additive";
/// Output message - source type.
...
//---------------------------------------------------//
/// Output message.
OutputMessage kOutFmtSensorName = kOutFmtVerticalLine +
                                  " %-32.32s                              " +
                                  kOutFmtEol;
/// Output message.
OutputMessage kOutFmtSensorFileUsage =
    kOutFmtVerticalLine +
    " + File usage:                                     %9.2fMB " + kOutFmtEol;

/// Output message.
OutputMessage kOutFmtSensorPressureRaw = "Pressure sensor p_raw";
/// Output message.
OutputMessage kOutFmtSensorPressureRms = "Pressure sensor p_rms";
/// Output message.
OutputMessage kOutFmtSensorPressureMax = "Pressure sensor p_max";
/// Output message.
OutputMessage kOutFmtSensorPressureMin = "Pressure sensor p_min";
/// Output message.
OutputMessage kOutFmtSensorPressureMaxAll = "Pressure sensor p_max_all";
/// Output message.
OutputMessage kOutFmtSensorPressureMinAll = "Pressure sensor p_min_all";
/// Output message.
OutputMessage kOutFmtSensorPressureFinal = "Pressure sensor p_final";

/// Output message.
OutputMessage kOutFmtSensorVelocityRaw = "Velocity sensor u_raw";
/// Output message.
OutputMessage kOutFmtSensorVelocityNonStaggeredRaw =
    "Velocity sensor u_non_staggered";
/// Output message.
OutputMessage kOutFmtSensorVelocityRms = "Velocity sensor u_rms";
/// Output message.
OutputMessage kOutFmtSensorVelocityMax = "Velocity sensor u_max";
/// Output message.
OutputMessage kOutFmtSensorVelocityMin = "Velocity sensor u_min";
/// Output message.
OutputMessage kOutFmtSensorVelocityMaxAll = "Velocity sensor u_max_all";
/// Output message.
OutputMessage kOutFmtSensorVelocityMinAll = "Velocity sensor u_min_all";
/// Output message.
OutputMessage kOutFmtSensorVelocityFinal = "Velocity sensor u_final";

/// Output message.
OutputMessage kOutFmtSimulatoinLenght =
    kOutFmtVerticalLine +
    " Simulation time steps:                              %9lu " + kOutFmtEol;
/// Output message.
